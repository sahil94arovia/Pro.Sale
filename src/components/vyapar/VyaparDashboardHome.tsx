...
export const VyaparDashboardHome: React.FC<VyaparDashboardHomeProps> = ({
  ...
  if (activeSubTab === 'recent_transactions') {
    return (
      <div className="space-y-6 max-w-7xl mx-auto pb-16 font-sans text-xs text-black animate-fade-in">
        <div className="p-6 bg-white rounded-3xl border border-neutral-200 shadow-apple-subtle space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-neutral-100">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="px-4 py-2 bg-black hover:bg-neutral-900 text-white rounded-xl font-bold text-xs flex items-center space-x-1.5 shadow-2xs cursor-pointer"
              >
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
            <div className="relative flex-1 min-w-[240px]">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 rounded-xl border border-neutral-200 bg-neutral-50 text-xs focus:bg-white focus:outline-none"
              />
            </div>
            ...
            <div className="flex items-center space-x-2">
              <select
                ...
                className="p-2 rounded-xl border border-neutral-200 bg-neutral-50 font-semibold text-xs"
              >
                ...
                {filteredLedgerInvoices.length === 0 ? (
                  ...
                  filteredLedgerInvoices.map((inv) => (
                    ...
                    >
                      ...
                      <td className="p-3 font-bold text-black font-mono">{inv.invoiceNumber}</td>
                      <td className="p-3 font-semibold text-neutral-900">{inv.customer.name}</td>
        ...
        <div className="p-6 bg-white rounded-3xl border border-neutral-200 shadow-apple-subtle space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-neutral-100">
            ...
            <button
              ...
              className="px-4 py-2 bg-neutral-100 hover:bg-neutral-200 text-neutral-800 rounded-xl font-bold text-xs cursor-pointer"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 pt-1">
            <div className="p-4 bg-neutral-50 rounded-2xl border border-neutral-200">
              <span className="text-[10px] uppercase font-bold text-neutral-400 block">Central GST (CGST)</span>
            ...
            <div className="p-4 bg-neutral-50 rounded-2xl border border-neutral-200">
              <span className="text-[10px] uppercase font-bold text-neutral-400 block">State GST (SGST)</span>
              <span className="text-xl font-bold font-mono text-neutral-900 mt-1 block">
            ...
            <div className="p-4 bg-neutral-50 rounded-2xl border border-neutral-200">
              <span className="text-[10px] uppercase font-bold text-neutral-400 block">Integrated GST (IGST)</span>
              <span className="text-xl font-bold font-mono text-neutral-900 mt-1 block">
            ...
            <div className="p-4 bg-neutral-900 text-white rounded-2xl">
              <span className="text-[10px] uppercase font-bold text-neutral-400 block">Total Output GST Collected</span>
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-16 font-sans text-xs text-black">
      {/* ========================================================================= */}
      {/* 4 PRIMARY METRIC CARDS (Majorly Black & White Apple Minimalism)           */}
      {/* 1: Actual Net Profit                                                      */}
      {/* 2: Credit Amount (Accounts Receivable)                                    */}
      {/* 3: Total Invoices & Turnover (Interactive Cursor-Moving Card)             */}
      {/* 4: Most Selling Product & Stock Valuation                                */}
      {/* ========================================================================= */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* CARD 1: ACTUAL NET PROFIT */}
        <div
          onClick={() => onNavigateTab('purchase')}
          className="p-5 bg-white rounded-2xl border border-black/[0.08] shadow-[0_2px_8px_rgba(0,0,0,0.03)] hover:border-black/25 hover:shadow-md cursor-pointer transition-all active:scale-[0.99] group relative overflow-hidden"
        >
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-semibold text-[#86868b] uppercase tracking-wider">
              Actual Net Profit
            </span>
            <div className="w-8 h-8 rounded-xl bg-black/[0.04] text-black border border-black/[0.04] flex items-center justify-center">
              <TrendingUp className="w-4 h-4" />
            </div>
          </div>
          <div className="mt-3">
            <span className="text-2xl font-bold font-sans text-black tracking-tight block">
              {formatINR(actualNetProfit)}
            </span>
            <p className="text-[11px] text-[#86868b] mt-1 font-normal">
              Gross: {formatINR(totalGrossProfit)} • Exp: {formatINR(totalExpenseAmount)}
            </p>
          </div>
          <div className="mt-3 pt-2.5 border-t border-black/[0.04] flex items-center justify-between text-[11px] text-black font-medium group-hover:text-black">
            <span>View Profit & Loss</span>
            <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-1 transition-transform text-[#86868b]" />
          </div>
        </div>
        ...
        <div
          ...
          style={{
            ...
            background: isHoveringTurnover
              ? `radial-gradient(circle at ${turnoverTilt.px}% ${turnoverTilt.py}%, rgba(0, 0, 0, 0.04), #ffffff 75%)`
              : '#ffffff',
          }}
          className="p-5 rounded-2xl border border-black/[0.08] shadow-[0_2px_8px_rgba(0,0,0,0.03)] hover:border-black/25 hover:shadow-md cursor-pointer group relative overflow-hidden"
        >
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-semibold text-[#86868b] uppercase tracking-wider">
      ...
      {/* ========================================================================= */}
      {/* QUICK LAUNCH ACTION BAR (Apple Monochrome Minimalist Controls)             */}
      {/* ========================================================================= */}
      <div className="p-4 bg-white rounded-2xl border border-black/[0.08] shadow-xs flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center space-x-2">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            onClick={onOpenAddSale}
            className="flex items-center space-x-1.5 px-4 py-2 bg-black hover:bg-neutral-900 text-white rounded-xl font-medium shadow-xs transition-all active:scale-95 cursor-pointer"
          >
            <Plus className="w-4 h-4" />
            <span>Add Sale Invoice (F2)</span>
          </button>

          {/* Add Purchase */}
          <button
            onClick={onOpenAddPurchase}
            className="flex items-center space-x-1.5 px-4 py-2 bg-white hover:bg-neutral-50 text-black border border-black/15 rounded-xl font-medium shadow-2xs transition-all active:scale-95 cursor-pointer"
          >
            <Plus className="w-4 h-4" />
          ...
          <button
            ...
            className="flex items-center space-x-1.5 px-3.5 py-2 bg-white hover:bg-neutral-50 text-black border border-black/15 rounded-xl font-medium shadow-2xs transition-all active:scale-95 cursor-pointer"
          >
            <ArrowDownLeft className="w-4 h-4" />
            <span>Receive Payment (F4)</span>
          </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left Column: Recent Sale Invoices Table (Apple Clean Table) */}
        <div className="lg:col-span-2 bg-white rounded-2xl border border-black/[0.08] shadow-xs overflow-hidden flex flex-col">
          <div className="px-5 py-3.5 border-b border-black/[0.06] flex items-center justify-between bg-[#fafafa]">
            <div>
              <h3 className="text-sm font-semibold text-black">Recent Sale Invoices</h3>
                ...
                {invoices.length === 0 ? (
                  <tr>
                    <td colSpan={7} className="py-8 text-center text-[#86868b] font-sans">
                      No invoices found. Click "Add Sale Invoice" to generate bills.
                    </td>
                  </tr>
                ) : (
                  invoices.slice(0, 6).map((inv) => (
                    ...
                    >
                      <td className="py-2.5 px-4 text-[#86868b] font-sans">{formatDate(inv.date)}</td>
                      <td className="py-2.5 px-4 font-semibold text-black group-hover:underline">
                        {inv.invoiceNumber}
                      </td>
                      <td className="py-2.5 px-4 font-medium text-black truncate max-w-[150px]">
                        {inv.customer.name}
                      </td>
                      ...
                      <td className="py-2.5 px-4 text-right font-semibold text-black font-mono">
                        {formatINR(inv.grandTotal)}
                      </td>
                      <td className="py-2.5 px-3 text-center">
                        <span
                      ...
                      <td className="py-2.5 px-4 text-right" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center justify-end space-x-1">
                          <button
                            ...
                            className="p-1 rounded-lg hover:bg-black/[0.05] text-[#86868b] hover:text-black transition-colors cursor-pointer"
                          >
                            <Printer className="w-3.5 h-3.5" />
                          </button>
                          <button
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-white rounded-2xl border border-black/[0.08] shadow-xs">
            ...
            <div className="divide-y divide-black/[0.04] mt-2">
              {productSalesMap.length === 0 ? (
                <div className="py-8 text-center text-[11px] text-[#86868b]">
                ...
                productSalesMap.slice(0, 4).map((p, idx) => (
                  <div key={idx} className="py-2.5 flex items-center justify-between">
                    <div className="flex items-center space-x-2.5 truncate">
                      <span className="w-5 h-5 rounded-full bg-black text-white font-semibold text-[10px] flex items-center justify-center flex-shrink-0">
                        {idx + 1}
                      </span>
                      <div className="truncate">
                        <p className="text-xs font-medium text-black truncate max-w-[160px]">
                          {p.name}
                        </p>
                    ...
                    <span className="text-xs font-semibold font-mono text-black flex-shrink-0">
                      {formatINR(p.revenue)}
                    </span>
                  </div>
                ))
          ...
          <div className="p-4 bg-white rounded-2xl border border-black/[0.08] shadow-xs">
            ...
            <div className="grid grid-cols-3 gap-2 mt-3 text-center">
              <div className="p-2 bg-[#fafafa] border border-black/[0.04] rounded-xl">
                <span className="text-[10px] text-[#86868b] block font-medium">CGST</span>
                <span className="text-xs font-semibold font-mono text-black">
                  {formatINR(totalCgstCollected)}
                </span>
              </div>
              <div className="p-2 bg-[#fafafa] border border-black/[0.04] rounded-xl">
                <span className="text-[10px] text-[#86868b] block font-medium">SGST</span>
                <span className="text-xs font-semibold font-mono text-black">
                  {formatINR(totalSgstCollected)}
                </span>
              </div>
              <div className="p-2 bg-[#fafafa] border border-black/[0.04] rounded-xl">
                <span className="text-[10px] text-[#86868b] block font-medium">IGST</span>
                <span className="text-xs font-semibold font-mono text-black">
                  {formatINR(totalIgstCollected)}
                </span>
              </div>
